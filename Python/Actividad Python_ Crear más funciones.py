...
# Tendencia general:
# La mayoría de los valores se encuentran entre 85 y 119, lo que parece ser el rango “normal” de intentos fallidos por mes.
# Valores atípicos (outliers):
# Los números 223 y 264 destacan claramente sobre el resto de los valores.
# Esto indica un aumento significativo en los intentos fallidos de inicio de sesión, que podría representar actividad sospechosa o un ataque de fuerza bruta en noviembre y diciembre.
# Importancia:
# Identificar estos valores atípicos es clave para la detección temprana de incidentes de seguridad.
# Permite priorizar investigaciones en los meses con picos inusuales de intentos fallidos.
...
# En este caso, el resultado debería ser 264, indicando el mes con actividad de inicio de sesión sospechosa que requiere investigación.
...
# Sí, el resultado cambia dependiendo de los argumentos que pases:
# 
# Si cambias el usuario (username), el nombre mostrado será diferente.
# Si cambias el número de intentos (current_day_logins), el número en el mensaje también cambiará.
...
# Sí, el mensaje cambia según los argumentos que pases:
# 
# Si cambias el usuario, se mostrará otro nombre.
# Si cambias current_day_logins, el primer y tercer mensaje cambiarán.
# Si cambias average_day_logins, el segundo y tercer mensaje también se actualizarán.
...
# Las versiones anteriores solo imprimían información, útil para revisión inmediata.
# La versión con return permite almacenar y reutilizar el valor de login_ratio, lo que la hace más versátil para análisis posteriores o integración con otros sistemas.
# 
# En esencia, ahora la función no solo comunica información, sino que también produce datos reutilizables.
...
# Este lab mostró cómo usar funciones con parámetros y return para calcular ratios de inicio de sesión, mostrar información y tomar decisiones automáticas con condicionales. Aprendimos a organizar el código, reutilizar resultados y generar alertas cuando la actividad supera el promedio, aplicable a análisis de seguridad.
