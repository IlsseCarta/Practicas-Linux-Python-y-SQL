...
system = "OS 1"   # prueba también con "OS 2" y "OS 3"
...
# Si pones "OS 2" → ✅ imprime: Your system is up-to-date.
# Pero si  pones "OS 1" o "OS 3" → ❌ no imprime nada
# 
...
# "OS 2" → ✅ Your system is up-to-date.
# "OS 1" o "OS 3" → ⚠️ Your system requires an update.
...
system = "OS 2"   # prueba con "OS 1", "OS 2", "OS 3" y otros como "OS 4"

if system == "OS 2":
    print("Your system is up-to-date.")
elif system == "OS 1":
    print("Your system requires an update.")
elif system == "OS 3":
    print("Your system requires an update.")
...
# "OS 2" → ✅ actualizado
# "OS 1" → ⚠️ necesita actualización
# "OS 3" → ⚠️ necesita actualización
# "OS 4" (u otro valor) → ❌ no imprime nada
...
# "OS 1" o "OS 3" → ⚠️ update needed
# otro valor → ❌ no muestra nada
...
# 
# Este ejercicio me enseñó lo esencial para controlar accesos en Python 🔐:
# 
# * Aprendí a usar variables (username, organization_hours) para guardar datos.
# * Usé listas (approved_list) para manejar varios usuarios de forma eficiente.
# * Apliqué el operador in para verificar si un usuario está autorizado.
# * Trabajé con condicionales (if/else) para tomar decisiones.
# * Utilicé Booleanos (True/False) para representar estados como el horario.
# * Finalmente, combiné condiciones con and para hacer una validación más completa.
