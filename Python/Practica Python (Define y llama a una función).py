...
# #### **Question 1**
# ¿Qué indica la función? 

# De inicio la función no indicó ningún resultado. Sin embargo, en caso de que se llamara a que imprimiera algún resultado, lo que provocaría es generar una alerta que indicaría al equipo de seguridad que hay posible problema de seguridad, y que debe investigarse más a fondo.
...
# Permite reutilizar el código y ejecutar la alerta automáticamente cuando se detecte actividad inusual.
# 
...
# 
# Versión anterior:
# Código fijo dentro de la función
# No toma argumentos
# Comportamiento siempre igual
# Versión actual:
# Puede recibir parámetros (inputs)
# Tiene condiciones o lógica interna
# Más flexible y reutilizable en diferentes escenarios
# 
...
def list_to_string():
    ...
    # Itera sobre la lista y muestra cada usuario
...
# La función recorre toda la lista y muestra cada elemento en orden, desde el primero hasta el último.
# Todavía no hemos convertido la lista en un solo string; por ahora solo estamos visualizando cada elemento individualmente.
...
def list_to_string():
    ...
    # Itera sobre cada usuario y concaténalo al string
    for username in username_list:
        sum_variable = sum_variable + username  # concatenación
        print(sum_variable)  # muestra el estado actual en cada iteración
...
# #### **Question 5**
# La concatenación permite combinar múltiples elementos de una lista en un solo string.
# Si queremos que sea más legible, podríamos agregar un separador (como coma o espacio) entre los nombres en la concatenación.
...
# La adición de , entre los nombres hace que el string final sea mucho más fácil de leer y útil para ponerlo en un archivo o reporte.

# ## Conclusion
# 
# **What are your key takeaways from this lab?**

# Este laboratorio mostró cómo usar funciones para automatizar tareas, recorrer listas con bucles y concatenar strings para crear salidas legibles. Estas técnicas facilitan procesar datos repetitivos y mantener el código organizado, algo clave en análisis y ciberseguridad.
