...
# Muestra el mensaje justo en ese momento. El bucle sigue normalmente después

# ## Conclusion
# **What are your key takeaways from this lab?**
# 
# En esta actividad se aplicó los bucles while a un caso práctico de automatización: 
# 
# * Generó IDs únicos dentro de un rango específico (5000–5150)
# * Se usó una condición (<=) para controlar el ciclo del bucle. 
# * Se aseguró que los valores fueran válidos usando incrementos de 5 en 5
# * Se usó una condición adicional (if) para mostrar una alerta en un punto clave
# * Se simuló un escenario real de negocio (gestión de empleados)    
# 
# 
# 
# 
