...
# Check if employee_id is less than 5 characters
if len(employee_id) < 5:
    employee_id = "E" + employee_id

# Display the updated employee_id
print(employee_id)
...
# 
# ind → donde empieza ".com"
# ind + 4 → avanza 4 caracteres (porque .com tiene 4)
# Extrae exactamente esa parte
# 
# 
...
# 
# También apliqué indexación y slicing para extraer información específica dentro de una cadena, lo cual es fundamental para analizar datos como identificadores y URLs. Además, utilicé el método .index() para localizar posiciones dentro de una cadena y así facilitar la extracción de información.
# 
# 
# También logré descomponer una URL en sus partes principales (protocolo, nombre del sitio y extensión), lo que refleja un uso práctico de estas herramientas en el análisis de datos reales.
# 
#     
# 
# 
